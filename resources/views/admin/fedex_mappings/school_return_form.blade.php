...
<div class="container">
    ...
    <form method="POST" 
          action="{{ isset($fedexMapping) 
              ? route('admin.fedex_mappings.school_return.update', $fedexMapping) 
              : route('admin.fedex_mappings.school_return.store') }}">
        @csrf
        ...
        <a href="{{ route('admin.fedex_mappings.school_return') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
