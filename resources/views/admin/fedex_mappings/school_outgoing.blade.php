    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-0">
                <i class="bi bi-truck me-2 text-primary"></i> School Outgoing FedEx Field Mappings
            </h2>
            <small class="text-muted">School Outgoing Mapping Table</small>
        </div>
        <a href="{{ route('admin.fedex_mappings.school_outgoing.create') }}" class="btn btn-primary shadow-sm">
                        ...
                        @forelse($mappings as $map)
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.fedex_mappings.school_outgoing.edit', $map) }}" 
                                           class="btn btn-sm btn-outline-primary" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.fedex_mappings.school_outgoing.destroy', $map) }}" 
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">
                                    ...
                                    No mappings found. 
                                    <a href="{{ route('admin.fedex_mappings.school_outgoing.create') }}" class="fw-bold text-primary">Add one now</a>.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
