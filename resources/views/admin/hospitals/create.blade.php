    ...
    <div class="col-lg-10">
        <div class="card shadow-lg border-0">
            <div class="card-header bg-danger text-white d-flex align-items-center py-3">
                ...
                <div>
                    <h4 class="mb-0 fw-bold">Add New Hospital</h4>
                    <small class="opacity-75">Enter hospital or healthcare organization information</small>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('valentine_opt_in') is-invalid @enderror" 
                                   id="valentine_opt_in" name="valentine_opt_in" value="{{ old('valentine_opt_in') }}" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('valentine_card_count') is-invalid @enderror" 
                                   id="valentine_card_count" name="valentine_card_count" value="{{ old('valentine_card_count') }}" 
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('extra_staff_cards') is-invalid @enderror" 
                                   id="extra_staff_cards" name="extra_staff_cards" value="{{ old('extra_staff_cards') }}" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('question') is-invalid @enderror" 
                                      ...
                                      placeholder="Any questions or additional information...">{{ old('question') }}</textarea>
                            @error('question')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control @error('introducer') is-invalid @enderror" 
                                      ...
                                      placeholder="How did you hear about us?">{{ old('introducer') }}</textarea>
                            @error('introducer')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control @error('prefilled_link') is-invalid @enderror" 
                                      ...
                                      placeholder="Any prefilled links or references...">{{ old('prefilled_link') }}</textarea>
