...
<div class="container">
    ...
    <form method="POST" 
          action="{{ isset($sendgridMapping) 
              ? route('admin.sendgrid_mappings.school.update', $sendgridMapping) 
              : route('admin.sendgrid_mappings.school.store') }}">
        @csrf
        ...
        <a href="{{ route('admin.sendgrid_mappings.school') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
